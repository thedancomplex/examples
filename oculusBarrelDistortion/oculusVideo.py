...
def sendImgUDP(src):
  ...
  global UDP_IP
  global UDP_PORT
#  img_str = np.toString(src)
  img_str = str(bytearray(src))
  jpg = compress_image(src)
  print('-------------')
  ...
  sock.sendto(jpg, (UDP_IP, UDP_PORT))
...
def getVideo():
                ...
                fraCom = joinImages(fraLresize, fraRresize)   # join resized images
